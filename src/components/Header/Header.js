...
const Header = () => {
  ...
  <div className="container">
    <Link className="navbar-brand" to="#"><img src="https://demo.web3canvas.com/themeforest/medenin/images/logo.png" alt="" /></Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item fw-bold">
          <Link className="nav-link active" to="/contract">Contract</Link>
        </li>
        {/* {
          user.email &&
