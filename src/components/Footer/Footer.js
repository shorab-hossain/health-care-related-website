            ...
            <div className="container">
                <div className="row pt-4 text-light pb-5">
                    <div className="mb-4 mt-4 col-lg-3" style={{color:'#dededebd'}}>
                        <img src="https://demo.web3canvas.com/themeforest/medenin/images/foot-logo.png" alt="" className="mb-3" />
                    ...
                    <div className="p-4 col-lg-3 buttlet">
                        ...
                        <li><a href="#"> <i className="fad fa-angle-double-right pe-2"></i>Our Mission</a></li>
                    ...
                    <h1 style={{color:'#5bc198'}}>Our Services</h1>
                        <li><a href="#"> <i className="fad fa-angle-double-right pe-2"></i>Pedirects</a></li>
                        <li><a href="#"> <i className="fad fa-angle-double-right pe-2"></i>Our Mission</a></li>
                        <li><a href="#"> <i className="fad fa-angle-double-right pe-2"></i>Dermatology</a></li>
                        <li><a href="#"> <i className="fad fa-angle-double-right pe-2"></i>Cardiology</a></li>
                        <li><a href="#"> <i className="fad fa-angle-double-right pe-2"></i>Pschology</a></li>
                        <li><a href="#"> <i className="fad fa-angle-double-right pe-2"></i>Surgary</a></li>
                    </div>
                    <div className="p-4 col-lg-3">
                            <button className="btn btn-outline-primary px-4 py-3 mb-3">Find a Doctor</button><br />
                            <button className="btn btn-outline-primary px-4 py-3 mb-3">Career</button><br />
